...
exports.dashboardWin = () => {
  ...
  win.on('minimize', () => logger.info(`dashboardWin@minimize`))
  win.on('hide', () => logger.info(`dashboardWin@hide`))
  win.on('restore', () => logger.info(`dashboardWin@restore`))
  win.on('show', () => logger.info(`dashboardWin@show`))
  win.on('close', (event) => logger.info(`dashboardWin@close`))
  win.on('closed', () => {
    win = null
    logger.info(`dashboardWin@closed`)
  })
